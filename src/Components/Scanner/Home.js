  ...
  return (
    <>
      ...
      <div className="hero_bg_box">
        <img src="assets/img/hero-bg.png" alt="" style={{ width: "100rem" }} />
      </div>
      <div className="container ">
            <br/>
            Explore our website to discover a wealth of resources and information about our cutting-edge imaging services, including MRI, CT scans, <br/> ultrasound, X-rays, and more. Whether you're seeking routine screenings, specialized diagnostics, or monitoring ongoing conditions, <br/>our experienced team is dedicated to delivering precise results in a comfortable and supportive environment.
            <br/>
          <p>For further check up and review of the doctor enter the patient details 
        ...
        <div className="row">
          ...
          >
            <div className="detail-box wow FadeInUp">
      ...
      <div className="container-fluid bg-success overflow-hidden  px-lg-0">
          ...
          <div className="row g-0 mx-lg-0">
            ...
            >
              <div className="p-lg-5 ps-lg-0">
                <p className="d-inline-block border rounded-pill text-light px-4">
                  Features
                </p>
